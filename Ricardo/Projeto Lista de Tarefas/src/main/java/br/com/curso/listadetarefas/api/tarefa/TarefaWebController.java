...
public class TarefaWebController {
    ...
    public String atualizarTarefaWeb(@PathVariable Long id, @RequestParam String titulo, @RequestParam(required = false) String descricao, Model model) {
        return tarefaService.findById(id)
                .map(tarefaExistente -> {
